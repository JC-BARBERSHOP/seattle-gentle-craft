    ...
    <section id="about" className="py-24 md:py-36 bg-background" ref={ref}>
      <div className="max-w-4xl mx-auto px-6 md:px-12 flex flex-col items-center text-center">
        ...
        <motion.p
          ...
          className="font-sans md:text-base tracking-[0.45em] uppercase text-primary mb-7 md:mb-8 text-base">
        ...
        <motion.h2
          ...
          className="font-serif md:text-7xl font-semibold text-foreground leading-tight text-4xl">
